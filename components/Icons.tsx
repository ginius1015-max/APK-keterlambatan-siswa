...
export const SaveIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 7h-2a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V9a2 2 0 00-2-2z" />
    </svg>
);

export const DocumentChartBarIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125V6.375m1.125 13.125A1.125 1.125 0 004.5 18.375h15M21 6.375V18.375m0-12A1.125 1.125 0 0019.875 5.25h-15A1.125 1.125 0 003.75 6.375m17.25 0v-1.5A2.25 2.25 0 0018.75 3H5.25A2.25 2.25 0 003 5.25v1.5m18 0h-2.25m-13.5 0h-2.25M7.5 12.75h.008v.008H7.5v-.008zm3.75 0h.008v.008h-.008v-.008zm3.75 0h.008v.008h-.008v-.008z" />
  </svg>
);